                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control nominal text-right" id="nominal" name="nominal" placeholder="0" value="<?= "Rp " . number_format($nominal,2,',','.'); ?>">
                                </div> 
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('input[name=nominal]').val(formatRupiah(nominal, 'Rp. '));
    })
