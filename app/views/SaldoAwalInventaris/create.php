                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label>Nama</label>
                                            <input type="text" class="form-control" name="namaInventaris" id="namaInventaris" required>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label>No. Register</label>
                                            <input type="number" class="form-control" name="noRegister" id="noRegister" required onkeyup="panjangNoRegister(this)">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="tahunPerolehan" placeholder="Tahun Perolehan" required>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nilaiBuku" placeholder="Nilai Buku" onkeyup="format(this)">
                                        </div>
                                    </div>
                                </div>
                            </div>
