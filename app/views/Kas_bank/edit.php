                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="nomor_kas_bank" id="nomor" placeholder="AUTO" value="<?= $kas_bank['nomor_kas_bank']; ?>" disabled>
                                                </div>
                                                <!-- <div class="col-md-6">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="date" class="form-control datepicker" name="tanggal" required value="<?= $kas_bank['tanggal']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
