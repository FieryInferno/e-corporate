                ...
                <div class="col-md-6">
                    <form action="javascript:save()" id="form1">
                        <div class="form-group">
                            ...
                            <select type="text" class="form-control" name="perusahaan" required value="{perusahaan}"></select>
                            ...
                            <select type="text" class="form-control" name="akunno" required value="{akunno}"></select>
                        </div>
