        ...
        <?php if ($status !== '3'): ?>
            <div class="header-elements d-none">
                <div class="d-flex justify-content-center">
                    <div class="btn-group">
                        <a href="{site_url}Pengiriman_penjualan/printpdf/{id}" target="_blank" class="btn btn-primary">
                            <?php echo lang('print') ?>
                        </a>
                        <a href="{site_url}Pengiriman_penjualan" class="btn btn-danger">
                            <?php echo lang('back') ?>
                        </a>
                    </div>
                </div>
        ...
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-md-6 text-left">
                    ...
                    <?php if ($status !== '3'): ?>
                        <div class="btn-group">
                            <a href="{site_url}faktur_penjualan/create?idpengiriman={id}" class="btn btn-outline-primary">
