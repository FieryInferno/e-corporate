    ...
    <div class="page-header-content header-elements-md-inline">
        ...
        <div class="header-elements d-none">
            <div class="d-flex justify-content-center">
                <div class="btn-group">
                    <a href="{site_url}Faktur_penjualan/printpdf/{id}" target="_blank" class="btn btn-primary">
                        <?php echo lang('print') ?>
                    </a>
                    <a href="{site_url}Faktur_penjualan" class="btn btn-danger">
                        <?php echo lang('back') ?>
                    </a>
                </div>
            </div>
                            ...
                            <tbody>
                                ...
                                <?php if ($totalkreditmemo > 0): ?>
                                     <tr>
                                        ...
                                        <td class="text-right font-weight-bold"><?php echo number_format($totalkreditmemo) ?></td>
                                    </tr>
                                <?php endif ?>
                            </tbody>
                        </table>
