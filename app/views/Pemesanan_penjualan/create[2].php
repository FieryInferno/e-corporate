...
<script type="text/javascript">
    ...
    function save_detail(no) {
        ...
        for ( index = 0; index < IsiItem.length; index++) {
            ...
            if ((jenisItem == 'barang') || (jenisItem == 'inventaris') || (jenisItem == 'jasa'))
            {
                tabel_detail_item.row.add([
                    IsiItem[index].value,
                    item,
                    `<input type="text" class="form-control" onkeyup="sum_item('${index}${no}', '${no}');" name="harga[]" id="harga${index}${no}">`,
                    `<input type="text" class="form-control" onkeyup="sum_item('${index}${no}', '${no}');" name="jumlah[]" id="jumlah${index}${no}">`,
                    ...
                    `KURS`,
                    `<input type="text" class="form-control" onkeyup="sum_total_item('${index}${no}', '${no}');" name="diskon[]" id="diskon${index}${no}">`,
                    `<input type="text" name="total_pajak[]" id="total_pajak${index}${no}" onchange="sum_total_item('${index}${no}', '${no}');">
                    ...
                    `<input type="text" name="biayapengiriman[]" id="biaya_pengiriman${index}${no}" onchange="sum_total_item('${index}${no}', '${no}');">
                    ...
                    `${noakun}`,
                    `<input type="text" class="form-control" name="total[]" id="total${index}${no}" readonly onchange="sum_total_item('${index}${no}', '${no}');">`,
                ...
                tabel_detail_budgetevent.row.add([
                    IsiItem[index].value,
                    item,
                    `<input type="text" class="form-control" onkeyup="sum_budgetevent('${index}${no}', '${no}');" name="harga[]" id="harga${index}${no}">`,
                    `<input type="text" class="form-control" onkeyup="sum_budgetevent('${index}${no}', '${no}');" name="jumlah[]" id="jumlah${index}${no}">`,
                    `<input type="text" class="form-control" id="subtotal${index}${no}" readonly><input type="hidden" name="subtotal[]" id="subtotal_asli${index}${no}" readonly>`,
                    `KURS`,
                    `<input type="text" class="form-control" onkeyup="sum_total_budgetevent('${index}${no}', '${no}');" name="diskon[]" id="diskon${index}${no}">`,
                    `<input type="text" name="total_pajak[]" id="total_pajak${index}${no}" onchange="sum_total_budgetevent('${index}${no}', '${no}');">
                    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal_pajak${index}${no}" title="Tambah Pajak">
                        <i class="fas fa-balance-scale"></i>
                    </button>`,
                    `<input type="text" name="biayapengiriman[]" id="biaya_pengiriman${index}${no}" onchange="sum_total_budgetevent('${index}${no}', '${no}');">
                    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal_pengiriman${index}${no}" title="Tambah Biaya Pengiriman">
                        <i class="fas fa-shipping-fast"></i>
                    </button>`,
                    `${noakun}`,
                    `<input type="text" class="form-control" name="total[]" id="total${index}${no}" readonly onchange="sum_total_budgetevent('${index}${no}', '${no}');">`,
                    `<a href="javascript:EditDetail('${IsiItem[index].value}','${jenisItem}')" class="edit_detail${IsiItem[index].value}"><i class="fas fa-pencil-alt"></i></a>&nbsp; 
                        <a href="javascript:void(0)" class="delete_detail_budgetevent text-danger"><i class="fas fa-trash"></i></a>`,
                    `${jenisItem}`
                ]).draw( false );
            }
    ...
    function save_edit_detail(no) {
        ...
        for ( index = 0; index < edit_isiitem.length; index++) {
            ...
            tabel_detail_item.row(edit_rowindex).data([
                ...
                `<input type="hidden" name="total_pajak[]" id="total_pajak${index}${edit_rowindex}" onchange="sum_total('${index}${edit_rowindex}', '${edit_rowindex}');">
                ...
                `<input type="hidden" name="biayapengiriman[]" id="biaya_pengiriman${index}${edit_rowindex}">
    ...
    $('#tabel_detail_budgetevent tbody').on('click','.delete_detail_budgetevent',function(){
        ...
        total_semua_budgetevent();
    })

    //hitung subtotal dan total
    function sum_item(no, no1) { 
    ...
    function sum_total_item(no, no1) {   
    ...
    //hitung total budgetevent
    function sum_budgetevent(no, no1) { 
        var txtFirstNumberValue                     = document.getElementById('harga'+no).value.replace(/[^,\d]/g, '').toString();    
        document.getElementById('harga'+no).value   = formatRupiah(txtFirstNumberValue, 'Rp.');
        var txtSecondNumberValue                    = document.getElementById('jumlah'+no).value;
        var result                                  = parseInt(txtFirstNumberValue) * parseInt(txtSecondNumberValue);
    ...
    function sum_total_budgetevent(no, no1) {   
       var subtotal            = document.getElementById('subtotal_asli'+no).value.replace(/[^,\d]/g, '').toString();
        if (isNaN(parseInt(subtotal))) {
            var subtotal   = 0;    
        }
    ...
    //hitung total tabel
    function total_semua_budgetevent() {
        a  = 0;
