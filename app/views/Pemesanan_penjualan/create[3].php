...
<script type="text/javascript">
        ...
        for ( index = 0; index < IsiItem.length; index++) {
            ...
            if (jenisItem != 'budgetevent')
            {
                ...
                tabel_detail_item.row.add([
                    ...
                    `<input type="hidden" name="total_pajak[]" id="total_pajak${index}${no}" onchange="sum_total('${index}${no}', '${no}','${jenisItem}');">
                    ...
                    `<input type="hidden" name="biayapengiriman[]" id="biaya_pengiriman${index}${no}" onchange="sum_total('${index}${no}', '${no}','${jenisItem}');">
                ...
                tabel_detail_budgetevent.row.add([
                    IsiItem[index].value,
                    item,
                    `<input type="text" class="form-control" onkeyup="sum('${index}${no}', '${no}','${jenisItem}');" name="harga1[]" id="harga${index}${no}">`,
                    `<input type="text" class="form-control" onkeyup="sum('${index}${no}', '${no}','${jenisItem}');" name="jumlah1[]" id="jumlah${index}${no}">`,
                    `<input type="text" class="form-control" id="subtotal${index}${no}" readonly><input type="hidden" name="subtotal1[]" id="subtotal_asli${index}${no}" readonly>`,
                    `KURS`,
                    `<input type="text" class="form-control" onkeyup="sum_total('${index}${no}', '${no}','${jenisItem}');" name="diskon1[]" id="diskon${index}${no}">`,
                    `<input type="hidden" name="total_pajak1[]" id="total_pajak${index}${no}" onchange="sum_total('${index}${no}', '${no}','${jenisItem}');">
                    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal_pajak${index}${no}" title="Tambah Pajak">
                        <i class="fas fa-balance-scale"></i>
                    </button>`,
                    `<input type="hidden" name="biayapengiriman1[]" id="biaya_pengiriman${index}${no}" onchange="sum_total('${index}${no}', '${no}','${jenisItem}');">
                    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal_pengiriman${index}${no}" title="Tambah Biaya Pengiriman">
                        <i class="fas fa-shipping-fast"></i>
                    </button>`,
                    `${noakun}`,
                    `<input type="text" class="form-control" name="total1[]" id="total${index}${no}" readonly onchange="sum_total('${index}${no}', '${no}','${jenisItem}');">`,
                    `<a href="javascript:EditDetail('${IsiItem[index].value}','${jenisItem}')" class="edit_detail${IsiItem[index].value}"><i class="fas fa-pencil-alt"></i></a>&nbsp; 
                        <a href="javascript:void(0)" class="delete_detail text-danger"><i class="fas fa-trash"></i></a>`,
                    `${jenisItem}`
                ]).draw( false );
        ...
        for ( index = 0; index < edit_isiitem.length; index++) {
            ...
            if (Edit_jenisItem != 'budgetevent'){
                ...
                tabel_detail_item.row(edit_rowindex).data([
                    ...
                    `<input type="hidden" name="total_pajak[]" id="total_pajak${index}${edit_rowindex}" onchange="sum_total('${index}${edit_rowindex}', '${edit_rowindex}','${Edit_jenisItem}');">
                    ...
                    `<input type="hidden" name="biayapengiriman[]" id="biaya_pengiriman${index}${edit_rowindex}" onchange="sum_total('${index}${edit_rowindex}', '${edit_rowindex}','${Edit_jenisItem}');">
    ...
    $('#tabel_detail_budgetevent tbody').on('click','.delete_detail',function(){
        var rowindex1    = tabel_detail_budgetevent.row($(this).parents('tr')).index();
        tabel_detail_budgetevent.row($(this).parents('tr')).remove().draw();
        detail_array_budgetevent();
        total_total_budgetevent.splice(rowindex1, 1);
