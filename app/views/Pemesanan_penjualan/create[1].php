    ...
    function save_detail(no) {
        ...
        for ( index = 0; index < IsiItem.length; index++) {
            ...
            tabel_detail.row.add([
                ...
                `KURS KOSONG`,
                `<input type="text" class="form-control" onkeyup="sum('${index}${no}', '${no}');sum_total('${index}${no}', '${no}');" name="diskon[]" id="diskon${index}${no}">`,
                `<input type="text" class="form-control" onkeyup="sum('${index}${no}', '${no}');sum_total('${index}${no}', '${no}');" name="ppn[]" id="ppn${index}${no}">`,
