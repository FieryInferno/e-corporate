    ...
    <div class="page-header-content header-elements-md-inline">
        ...
        <div class="header-elements d-none">
            <div class="d-flex justify-content-center">
                <div class="btn-group">
                    <a href="{site_url}Pemesanan_penjualan/printpdf/{id}" target="_blank" class="btn btn-primary">
                        <?php echo lang('print') ?>
                    </a>
                    <a href="{site_url}Pemesanan_penjualan" class="btn btn-danger">
                        <?php echo lang('back') ?>
                    </a>
                </div>
            </div>
                ...
                <div class="col-md-6 text-left">
                    <div class="btn-group">
                        <?php if ($status !== '3'): ?>
                            ...
                            <a href="{site_url}faktur_penjualan/create?idpemesanan={id}" class="btn btn-outline-primary">
