                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control hargabeli" name="hargabeli" required value="{hargabeli}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control hargajual" name="hargajual" required value="{hargajual}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <!-- <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control departemen" name="departemen"></select>
                        </div>
                    </div> -->
                </div>
                <div class="row">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        ajax_select({ id: '.noakunbeli', url: base_url + 'select2_noakunbeli', selected: { id: '{noakunbeli}' } });
        ajax_select({ id: '.noakunjual', url: base_url + 'select2_noakunjual', selected: { id: '{noakunjual}' } });
