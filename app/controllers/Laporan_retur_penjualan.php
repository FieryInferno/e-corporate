...
class Laporan_retur_penjualan extends User_Controller {
	...
	public function index() {
		...
		$data['title'] = lang('sales_return_report');
		$data['subtitle'] = lang('list');
		$data['content'] = 'Laporan_retur_penjualan/index';
	...
	public function printpdf() {
	    ...
	    $data = array_merge($data,path_info());
	    $html = $this->load->view('Laporan_retur_penjualan/printpdf', $data, TRUE);
	    $pdf->loadHtml($html);
